...
var cssContainerOuter = css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    position: relative;\n    display: block;\n    margin-left: auto;\n    margin-right: auto;\n"], ["\n    position: relative;\n    display: block;\n    margin-left: auto;\n    margin-right: auto;\n"])));
var cssContainerInner = css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    position: relative;\n    display: block;\n    top: 0;\n    left: 0;\n"], ["\n    position: relative;\n    display: block;\n    top: 0;\n    left: 0;\n"])));
var cssAsset = css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    margin: 0;\n    vertical-align: middle;\n    top: 0;\n    left: 0;\n"], ["\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    margin: 0;\n    vertical-align: middle;\n    top: 0;\n    left: 0;\n"])));
...
var FastImageImage = /** @class */ (function (_super) {
    ...
    function FastImageImage(props) {
        ...
        _this.onNextFrame = function () {
            if (_this.media && _this.outer && _this.inner) {
                _this.media.className = cx(cssAsset, _this.props.classNameMedia, _this.props.classNameMediaVisible);
                _this.outer.className = cx(cssContainerOuter, _this.props.className, _this.props.classNameVisible);
                _this.inner.className = cx(cssContainerInner, _this.props.classNameContainer, _this.props.classNameContainerVisible);
            }
        };
        ...
        _this.onVisible = function () {
            ...
            media.className = cx(cssAsset, _this.props.classNameMedia);
            _this.media = media;
        };
    ...
    FastImageImage.prototype.render = function () {
        ...
        return (React.createElement("span", { style: { width: width }, className: cx(cssContainerOuter, className), ref: this.captureOuterRef },
            React.createElement("span", { className: cx(cssContainerInner, classNameContainer), style: {
...
var FastImage = /** @class */ (function (_super) {
    ...
    FastImage.prototype.render = function () {
        if (this.props.imgSrc) {
            ...
            return (React.createElement(FastImageImage, __assign({ src: imgSrc, srcSet: imgSrcSet, base64: imgBase64, webPSrc: imgWebPSrc, webPSrcSet: imgWebPSrcSet, alt: imgAlt, sizes: imgSizes }, otherProps)));
        }
        if (this.props.videoSrc) {
            ...
            return (React.createElement(FastImageVideo, __assign({ src: videoSrc, posterSrc: videoPosterSrc, posterWebPSrc: videoPosterWebPSrc, posterBase64: videoPosterBase64 }, otherProps)));
        }
...
export { FastImage, FastImageImage, FastImageVideo };
